function getInfo() {
  ...
  // Set up request
  xhr.open('GET', 'https://lnw6c9y3z5.execute-api.ap-southeast-1.amazonaws.com/prod', true);
...
function submitForm() {
  ...
  // Set up request
  xhr.open('POST', 'https://lnw6c9y3z5.execute-api.ap-southeast-1.amazonaws.com/prod', true);
  xhr.setRequestHeader('Content-Type', 'application/json');
